...
class SiswaTei1 extends Component {
  state = {
    users: [
      {
        foto: "img",
        ...
        formatter: (cellContent, row) => {
          return (
            <div>
              ...
              <Row>
                <Col md={6}>
                  <Link to={`/admin/tei/edit-siswa-tei1`}>
    ...
    return (
      <div>
        <div className="container" style={{ boxShadow:'5px 5px 10px #D3D3D3', padding: "60px" }}>
          <div id="row">
            <h3> FOTO SISWA TEKNIK ELEKTRONIKA INDUSTRI 1 </h3>
            <div id="end">
              <Link to="/admin/tei/foto-siswa-tei1/post-siswa-tei1">
