              ...
              <Card.Text as="div">
                <Row>
                  <div class="grid grid-cols-3 gap-4 pt-4">
                    ...
                    <div className="flex flex-col justify-center items-center rounde2  ">
                      <div className="flex flex-col justify-center items-center">
                        {/* <span className="after:content-['*'] after:ml-0.5 after:text-red-500 text-md text-gray-700 font-semibold whitespace-nowrap mb-2 text-left">
                          Gambar
                        </span> */}
                        ...
                        {preview ? (
                          ...
                          <div className="mt-3 w-64 h-64 object-cover rounded border-dashed border-2 border-gray-300 flex justify-center items-center mb-3">
                            <FontAwesomeIcon className="text-gray-400 text-[100px]" icon={faImage} />
                          </div>
                        )}
                        <label className="block font-semibold">
                          <input
