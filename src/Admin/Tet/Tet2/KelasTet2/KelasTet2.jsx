...
class KelasTet2 extends Component {
  state = {
    users: [
      {
        foto: "img",
        ...
        formatter: (cellContent, row) => {
          return (
            <div>
              ...
              <Row>
                <Col md={3}>
                  <Link to={`/admin/tet/edit-kelas-tet2`}>
    ...
    return (
      <div>
        <div className="container" style={{ boxShadow:'5px 5px 10px #D3D3D3', padding: "60px" }}>
          <div id="row">
            <h3> FOTO KELAS TEKNIK ENERGI TERBARUKAN 2 </h3>
            
            <div id="end">
              <Link to="/admin/tet/foto-kelas-tet2/post-kelas-tet2">
