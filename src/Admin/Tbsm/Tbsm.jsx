  ...
  return (
        <div>
          ...
          <div id="row">
            ...
            <tbody>
              <tr>
                <td>XII TEKNIK BISNIS SEPEDA MOTOR 1</td>
                <td>Table cell</td>
                <td>Table cell</td>
              </tr>
              <tr>
                <td>XII TEKNIK BISNIS SEPEDA MOTOR 2</td>
                <td>Table cell</td>
                <td>Table cell</td>
              </tr>
              <tr>
                <td>XII TEKNIK BISNIS SEPEDA MOTOR 3</td>
                <td>Table cell</td>
                <td>Table cell</td>
              </tr>
              <tr>
                <td>XII TEKNIK BISNIS SEPEDA MOTOR 4</td>
                <td>Table cell</td>
                <td>Table cell</td>
              </tr>
            </tbody>
