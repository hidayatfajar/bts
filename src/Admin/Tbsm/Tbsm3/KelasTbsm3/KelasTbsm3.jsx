...
import "./KelasTbsm3.css";
import React, { Component } from "react";
import "react-bootstrap-table-next/dist/react-bootstrap-table2.min.css";
import BootstrapTable from "react-bootstrap-table-next";
import { FaTrash, FaEdit } from "react-icons/fa";

class KelasTbsm3 extends Component {
  state = {
    users: [
      {
        foto: "img",
        ...
        formatter: (cellContent, row) => {
          return (
            <div>
              ...
              <Row>
                <Col md={3}>
                  <Link to={`/admin/tbsm/edit-kelas-tbsm3`}>
    ...
    return (
      <div>
        <div className="container" style={{ boxShadow:'5px 5px 10px #D3D3D3', padding: "60px" }}>
          <div id="row">
            <h3> FOTO KELAS TEKNIK SEPEDA MOTOR 3 </h3>
            
            <div id="end">
              <Link to="/admin/tbsm/foto-kelas-tbsm3/post-kelas-tbsm3">
