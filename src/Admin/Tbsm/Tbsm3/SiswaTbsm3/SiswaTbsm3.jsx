...
class SiswaTbsm3 extends Component {
  state = {
    users: [
      {
        foto: "img",
        ...
        formatter: (cellContent, row) => {
          return (
            <div>
              ...
              <Row>
                <Col md={6}>
                  <Link to={`/admin/tbsm/edit-siswa-tbsm3`}>
    ...
    return (
      <div>
        <div className="container" style={{ boxShadow:'5px 5px 10px #D3D3D3', padding: "60px" }}>
          <div id="row">
            <h3> FOTO SISWA TEKNIK SEPEDA MOTOR 3 </h3>
            <div id="end">
              <Link to="/admin/tbsm/foto-siswa-tbsm3/post-siswa-tbsm3">
