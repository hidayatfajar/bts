...
class KelasAk2 extends Component {
  state = {
    users:[
      {
        foto: "img",
          ...
          return (
            <div>
              {/* <Sidebar /> */}
                <Row>
                  <Col md={3}>
                  <Link to={`/admin/ak/edit-kelas-ak2`}>
    ...
    return (
      <div>
        <div className="container" style={{boxShadow:'5px 5px 10px #D3D3D3', padding:'20px'}}>
          <div id="row">
            <h3> FOTO KELAS AKUNTANSI 2 </h3>
              <div id="end">
                <Link to="/admin/ak/foto-kelas-ak2/post-kelas-ak2">
