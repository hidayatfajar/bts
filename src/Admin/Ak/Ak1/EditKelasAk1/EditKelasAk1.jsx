...
class EditKelasAk1 extends Component{
  render(){
    return(
      <div> 
        ...
        <section className="kontent">
          <div className="container" style={{boxShadow:'5px 5px 10px #D3D3D3', padding:'20px'}}>
            <div className="content">
              <div className="row">
                <h2 className='mt-3'>EDIT FOTO KELAS AK 1 </h2>
              </div>
            </div>
        ...
        <section>
          <div className="container mt-3">
            <Link to="/admin/ak/foto-kelas-ak1">
