...
import './PostSiswaRpl1.css';
import img from '../../../../Assets/icons-img.svg';

class PostSiswaRpl1 extends Component{
  render(){
    return(
      <div> 
        ...
        <section className="kontent">
          <div className="container" style={{boxShadow:'5px 5px 10px #D3D3D3', padding:'20px'}}>
            <div className="content">
              <div className="row">
                <h2 className='mt-3'>Post Foto Siswa RPL 1</h2>
              </div>
            </div>
          ...
          <Link to="/admin/rpl/foto-siswa-rpl1"> 
