...
import './PostGambarGuru.css';
import img from '../../Assets/icons-img.svg';

class PostGambarGuru extends Component{
  render(){
    return(
      <div> 
        ...
        <section className="kontent">
          <div className="container" style={{boxShadow:'5px 5px 10px #D3D3D3', padding:'20px'}}>
            <div className="content">
              <div className="row">
                <h2 className='mt-3'>Post Foto Guru</h2>
              </div>
            </div>
          ...
          <div className="row mt-5">
            ...
            <>
              ...
              <h5>Jabatan</h5>
              <FloatingLabel controlId="floatingTextarea2" label="Input Jabatan" className="input-text">
                <Form.Control
                  as="textarea"
                  placeholder="Leave a comment here"
                  style={{ height: '100px' }}
